export const businessInfo = {
  ...
  name: "Santa's North Pole Workshop",
  tagline: "Spreading Christmas Joy & Magic Since 1823",
  logo: "/logo.png",

  // Contact information
  phone: "(555) HO-HO-HO",
  phoneSecondary: "(555) ELF-HELP", // Optional second phone number
  ...
  social: {
    facebook: "https://facebook.com/santaclaus",
    instagram: "https://instagram.com/thenorthpole",
  ...
  description: "Dedicated to spreading Christmas cheer, delivering presents, and making children's dreams come true around the world.",
  priceRange: "$$", // $, $$, $$$, or $$$$
  ...
  maps: {
    ...
    locationName: "Santa's North Pole Workshop",
  },
}
