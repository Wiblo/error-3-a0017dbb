...
// Extend window type for shared error tracking
declare global {
  interface Window {
...
export function WibloDesignBridge() {
  useEffect(() => {
    // Use shared dedupe set from early error bridge
    ...
    // --- Next.js Error Overlay Detection (backup to early script) ---
